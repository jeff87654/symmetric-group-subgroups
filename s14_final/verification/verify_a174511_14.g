...
# Initialize output
PrintTo(PHASE_B_FILE, "# Phase B: Invariants for 75,154 S14 conjugacy class reps\n");
...
for _i in [1..EXPECTED_CLASSES] do
    ...
    # Checkpoint
    if _i mod 100 = 0 or _i = EXPECTED_CLASSES then
        AppendTo(PHASE_B_FILE, "  # group ", _i, "\n");
    fi;
...
AppendTo(PHASE_B_FILE, "# Phase B complete: ", _idgCount, " IdGroup-compatible, ",
         _largeCount, " large\n");
